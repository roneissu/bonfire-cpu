...
--
-- Generated by wigen at Sun May  7 17:44:44 2017
--
-- Configuration:
--     Number of masters:     2
--     Number of slaves:      1
--     Master address width:  32
--     Slave address width:   32
--     Port size:             32
--     Port granularity:      8
--     Entity name:           bonfire_wb_connect
--     Pipelined arbiter:     no
--     Registered feedback:   yes
--     Unsafe slave decoder:  no
--
-- Command line:
--     wigen -e bonfire_wb_connect -r 2 1 32 32 32 8
---------------------------------------------------------------------

library ieee;
use ieee.std_logic_1164.all;

entity bonfire_wb_connect is
	port(
		clk_i: in std_logic;
		rst_i: in std_logic;
		...
		m0_adr_o: out std_logic_vector(31 downto 2);
		m0_dat_o: out std_logic_vector(31 downto 0);
		m0_dat_i: in std_logic_vector(31 downto 0)
	);
end entity;

architecture rtl of bonfire_wb_connect is
